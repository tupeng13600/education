...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="${pageContext.request.contextPath}/upc/login" method="post">
      ...
      <div class="row">
        <div class="col-xs-8">
              <%--<a href="#" style="float: right;margin-top: 10px;font-size: 10px;">忘记密码?</a>--%>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
        ...
        <a href="#" style="float: right;margin-top: 10px;font-size: 10px;">忘记密码?</a><br>
    </form>
  </div>
</div>
<!-- /.login-box -->
